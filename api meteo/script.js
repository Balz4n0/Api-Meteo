                    ...
                    datasets: [
                        {
                            ...
                            backgroundColor: 'rgba(0, 0, 0, 0.2)', // Nero trasparente
                            fill: false,
                            tension: 0.1,
                            pointBackgroundColor: 'rgba(0, 0, 0, 1)', // Nero
                            pointBorderColor: 'rgba(0, 0, 0, 1)', // Nero
                        },
                        {
                            label: 'Codice Meteo',
                            data: weatherCodeData,
                            borderColor: 'rgba(255, 255, 255, 1)', // Bianco
                            backgroundColor: 'rgba(255, 255, 255, 0.2)', // Bianco trasparente
                            fill: false,
                            tension: 0.1,
                            pointBackgroundColor: 'rgba(255, 255, 255, 1)', // Bianco
                            pointBorderColor: 'rgba(255, 255, 255, 1)', // Bianco
                        }
                    ]
                },
                options: {
                    ...
                    scales: {
                        x: {
                            ticks: {
                                color: '#ffffff' // Colore dei tick dell'asse X
                            },
                            grid: {
                        ...
                        y: {
                            ticks: {
                                color: '#ffffff' // Colore dei tick dell'asse Y
                            },
                            grid: {
                    ...
                    plugins: {
                        legend: {
                            labels: {
                                color: '#ffffff' // Colore delle etichette della legenda
                            }
                        }
                    }
                }
